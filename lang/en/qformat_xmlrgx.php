...
/**
 * Strings for component 'qformat_xmlrgx', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['pluginname'] = 'Moodle XML format for multianswer with regexp questions';
$string['pluginname_help'] = 'This is a Moodle-specific format for importing and exporting questions.';
$string['pluginname_link'] = 'qformat/xmlrgx';
...
$string['unsupportedexport'] = 'Question type {$a} is not supported by XMLrgx export';
